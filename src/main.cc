...
void simulation_run(const Config& configs, Memory<T, Controller>& memory, const Config& configs2, Memory<T2, Controller>& memory2)
{
  ...
  CACHE LLC("LLC", CACHE_CLOCK_SCALE, LLC_LEVEL, 2048, 16, 32, 32, 32, 64, 19, 1, 1, 1, LOG2_BLOCK_SIZE, 0, 0, 0, 5, &memory_controller, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  CACHE cpu0_L2C("cpu0_L2C", CACHE_CLOCK_SCALE, L2C_LEVEL, 1024, 8, 32, 32, 16, 32, 9, 1, 1, 1, LOG2_BLOCK_SIZE, 0, 0, 0, 5, &LLC, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  CACHE cpu0_L1D("cpu0_L1D", CACHE_CLOCK_SCALE, L1D_LEVEL, 64, 12, 64, 64, 8, 16, 4, 1, 2, 2, LOG2_BLOCK_SIZE, 0, 1, 0, 5, &cpu0_L2C, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  PageTableWalker cpu0_PTW("cpu0_PTW", 0, PTW_LEVEL, 1, 2, 1, 4, 2, 4, 4, 8, 16, 5, 2, 2, 0, &cpu0_L1D, vmem);
  CACHE cpu0_STLB("cpu0_STLB", CACHE_CLOCK_SCALE, STLB_LEVEL, 128, 12, 32, 32, 0, 16, 7, 1, 1, 1, LOG2_PAGE_SIZE, 0, 0, 0, 5, &cpu0_PTW, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  CACHE cpu0_L1I("cpu0_L1I", CACHE_CLOCK_SCALE, L1I_LEVEL, 64, 8, 64, 64, 32, 8, 3, 1, 2, 2, LOG2_BLOCK_SIZE, 0, 1, 1, 5, &cpu0_L2C, CACHE::pref_t::CPU_REDIRECT_pprefetcherDno_instr_, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  CACHE cpu0_ITLB("cpu0_ITLB", CACHE_CLOCK_SCALE, ITLB_LEVEL, 16, 4, 16, 16, 0, 8, 0, 1, 2, 2, LOG2_PAGE_SIZE, 0, 1, 1, 5, &cpu0_STLB, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  CACHE cpu0_DTLB("cpu0_DTLB", CACHE_CLOCK_SCALE, DTLB_LEVEL, 16, 4, 16, 16, 0, 8, 0, 1, 2, 2, LOG2_PAGE_SIZE, 0, 1, 0, 5, &cpu0_STLB, CACHE::pref_t::pprefetcherDno, CACHE::repl_t::rreplacementDlru, ooo_cpu, vmem);
  O3_CPU cpu0(0, O3_CPU_CLOCK_SCALE, 32, 8, 16, 64, 32, 32, 352, 128, 72, 6, 6, 6, 128, 4, 2, 2, 5, 1, 1, 1, 0, 0, &cpu0_ITLB, &cpu0_DTLB, &cpu0_L1I, &cpu0_L1D, O3_CPU::bpred_t::bbranchDbimodal, O3_CPU::btb_t::bbtbDbasic_btb, O3_CPU::ipref_t::pprefetcherDno_instr);
