...
SALP::SALP(Org org, Speed speed, Type type, int n_sa): type(type),
                                                       n_sa(n_sa),
...
SALP::SALP(const string& org_str, const string& speed_str, const string& type_str, int n_sa): SALP(org_map[org_str], speed_map[speed_str], type_map[type_str], n_sa)
{
}
