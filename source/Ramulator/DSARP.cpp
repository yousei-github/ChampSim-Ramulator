...
DSARP::DSARP(Org org, Speed speed, Type type, int n_sa): type(type),
...
DSARP::DSARP(const string& org_str, const string& speed_str, Type type, int n_sa): DSARP(org_map[org_str], speed_map[speed_str], type, n_sa) {}
