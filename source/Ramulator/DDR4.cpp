...
DDR4::DDR4(const string& org_str, const string& speed_str): DDR4(org_map[org_str], speed_map[speed_str])
{
}
...
void DDR4::init_speed()
{
    ...
    speed_entry.nFAW  = FAW_TABLE[org_entry.dq == 4 ? 0 : org_entry.dq == 8 ? 1 :
                                                                              2][speed];
