...
WideIO2::WideIO2(Org org, Speed speed, int channels): speed_entry(speed_table[int(speed)]),
...
WideIO2::WideIO2(const string& org_str, const string& speed_str, int channels): WideIO2(org_map[org_str], speed_map[speed_str], channels)
{
}
