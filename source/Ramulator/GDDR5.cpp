...
GDDR5::GDDR5(Org org, Speed speed): org_entry(org_table[int(org)]),
...
GDDR5::GDDR5(const string& org_str, const string& speed_str): GDDR5(org_map[org_str], speed_map[speed_str])
{
}
