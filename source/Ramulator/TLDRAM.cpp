...
TLDRAM::TLDRAM(Org org, Speed speed, int segment_ratio): segment_ratio(segment_ratio),
...
TLDRAM::TLDRAM(const string& org_str, const string& speed_str, int segment_ratio): TLDRAM(org_map[org_str], speed_map[speed_str], segment_ratio)
{
    this->segment_ratio = segment_ratio;
}
