...
STTMRAM::STTMRAM(Org org, Speed speed): org_entry(org_table[int(org)]),
...
STTMRAM::STTMRAM(const string& org_str, const string& speed_str): STTMRAM(org_map[org_str], speed_map[speed_str])
{
}
...
void STTMRAM::init_speed()
{
    ...
    {
    case 1600:
        speed_entry.nXS = ceil(speed_entry.nXS * ((chip == 512) ? 80 : (chip == 1 << 10) ? 96 :
                                                                   (chip == 1 << 11)     ? 136 :
                                                                   (chip == 1 << 12)     ? 216 :
                                                                                           288) /
                               10.0);
