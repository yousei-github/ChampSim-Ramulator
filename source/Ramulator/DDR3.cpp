...
DDR3::DDR3(Org org, Speed speed): org_entry(org_table[int(org)]),
...
DDR3::DDR3(const string& org_str, const string& speed_str): DDR3(org_map[org_str], speed_map[speed_str])
{
}
