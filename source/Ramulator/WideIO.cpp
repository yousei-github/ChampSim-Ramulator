...
WideIO::WideIO(Org org, Speed speed): org_entry(org_table[int(org)]),
...
WideIO::WideIO(const string& org_str, const string& speed_str): WideIO(org_map[org_str], speed_map[speed_str])
{
}
