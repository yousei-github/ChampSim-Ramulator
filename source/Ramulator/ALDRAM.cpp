...
ALDRAM::ALDRAM(Org org, Speed speed): org_entry(org_table[int(org)]),
...
ALDRAM::ALDRAM(const string& org_str, const string& speed_str): ALDRAM(org_map[org_str], speed_map[speed_str])
{
}
