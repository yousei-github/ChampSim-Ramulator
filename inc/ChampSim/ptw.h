...
public:
  ...
  PagingStructureCache(std::string v1, uint8_t v2, uint32_t v3, uint32_t v4, VirtualMemory& vmem) : NAME(v1), NUM_SET(v3), NUM_WAY(v4), level(v2), vmem(vmem) {}
...
public:
  ...
  PageTableWalker(std::string v1, uint32_t cpu, unsigned fill_level, uint32_t v2, uint32_t v3, uint32_t v4, uint32_t v5, uint32_t v6, uint32_t v7, uint32_t v8,
                  uint32_t v9, uint32_t v10, uint32_t v11, uint32_t v12, uint32_t v13, unsigned latency, MemoryRequestConsumer* ll, VirtualMemory& vmem);
